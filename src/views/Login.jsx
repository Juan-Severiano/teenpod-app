...
import { View, Text, StyleSheet, TouchableOpacity, TextInput, Linking, FlatList, ImageBackground, Alert } from 'react-native'
...
export default class Login extends Component {
  ...
  render() {
    return (
      <ImageBackground source={require('../../assets/TeenPod-AuthPage.png')} style={styles.container}>
